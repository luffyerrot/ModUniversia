...
public class TileEntityRampBlockSpecialRendererNorth extends TileEntitySpecialRenderer<TileEntityRampBlockNorth>{
	...
	public void renderTileEntityRampAt(TileEntityRampBlockNorth tileEntity, double posX, double posY, double posZ, float partialTicks, int damageCount) {
	...
	@Override
	public void render(TileEntityRampBlockNorth te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
