...
public class CentrifugeuseRecipes {

    private static final Map <ItemStack[], ItemStack>recipes = new Hashtable<>();
    static {

        addRecipe(ModItems.weed_synthetique, ModItems.fiol, ModItems.fiol, ModItems.fiol, ModItems.fiol, Items.WATER_BUCKET, ModItems.fiol_weed_synthetique);
        addRecipe(ModItems.bulbe_synthetique, ModItems.fiol, ModItems.fiol, ModItems.fiol, ModItems.fiol, Items.WATER_BUCKET, ModItems.fiol_bulbe_synthetique);
        addRecipe(ModItems.coca_synthetique, ModItems.fiol, ModItems.fiol, ModItems.fiol, ModItems.fiol, Items.WATER_BUCKET, ModItems.fiol_coca_synthetique);
    }
