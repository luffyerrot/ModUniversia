...
public class ImprimanteRecipe1 {

    private static final ImprimanteRecipe1 INSTANCE = new ImprimanteRecipe1();
    
    public static ImprimanteRecipe1 getInstance()
    {
        return INSTANCE;
    }
    ...
    static {
		addRecipe(ModItems.fiol_encre,  ModItems.fiol_encre_jaune, ModItems.fiol_encre_cyan, ModItems.fiol_encre_magenta, ModItems.papier_impression, ModItems.billet50_faux);
    }
