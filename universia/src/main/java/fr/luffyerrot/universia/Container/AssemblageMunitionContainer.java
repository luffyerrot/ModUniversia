...
public class AssemblageMunitionContainer extends Container {

    private TileEntityAssemblageMunition tile;
    private int	timePassed = 0;
    private int	burnTimeLeft = 0;

    public AssemblageMunitionContainer(InventoryPlayer playerInventory, TileEntityAssemblageMunition tile) {
        this.tile = tile;
        ...
        this.addSlotToContainer(new Slot(tile, 4, 80, 33));
        
        this.addSlotToContainer(new Slot(tile, 5, 102, 33));
        
        this.addSlotToContainer(new Slot(tile, 6, 58, 55));
        
        this.addSlotToContainer(new Slot(tile, 7, 80, 55));
        
        this.addSlotToContainer(new Slot(tile, 8, 102, 55));
        
        this.addSlotToContainer(new SlotTableAssemblageOutput(tile, 9, 149, 33));
