...
import fr.luffyerrot.universia.Recipes.AssemblageArmeRecipes;
...
public class TileEntityAssemblageArme extends TileEntityLockable implements ITickable {
    ...
    public String getName() {
        return hasCustomName() ? this.customName : "AssemblageArme";
    }
    ...
    public ItemStack getRecipeResult() {
        return AssemblageArmeRecipes.getRecipeResult(new ItemStack[] {this.getStackInSlot(0), this.getStackInSlot(1), this.getStackInSlot(2), this.getStackInSlot(3), 
