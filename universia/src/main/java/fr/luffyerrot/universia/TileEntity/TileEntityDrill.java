...
import fr.luffyerrot.universia.Recipes.DrillRecipes;
...
public class TileEntityDrill extends TileEntityLockable implements ITickable {
    ...
    public String getName() {
        return hasCustomName() ? this.customName : "Forreuse";
    }
    ...
    public ItemStack getRecipeResult() {
        return DrillRecipes.getRecipeResult(new ItemStack[] {this.getStackInSlot(0)});
    }
    ...
    public boolean canSmelt() {
        ...
        if (result != null) {
            ...
            if (slot2.getItem() == ModItems.batterie) {
