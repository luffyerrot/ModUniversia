...
import fr.luffyerrot.universia.Recipes.AssemblageMunitionRecipes;
...
public class TileEntityAssemblageMunition extends TileEntityLockable implements ITickable {
    ...
    public String getName() {
        return hasCustomName() ? this.customName : "AssemblageMunition";
    }
    ...
    public ItemStack getRecipeResult() {
        return AssemblageMunitionRecipes.getRecipeResult(new ItemStack[] {this.getStackInSlot(0), this.getStackInSlot(1), this.getStackInSlot(2), this.getStackInSlot(3), 
