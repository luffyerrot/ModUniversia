...
public class BlockCropSalade extends BlockCrops {
    ...
    public BlockCropSalade(String name){
    ...
    protected Item getSeed(){
        ...
        return ModItems.salade_seed;
    }

    @Override
    protected Item getCrop(){

        return ModItems.feuille_salade;
    } 
    
    protected Item getCrop2(){

        return ModItems.coeur_salade;
    }
