...
public class GuiDrill extends GuiContainer {
    ...
    private static final ResourceLocation background = new ResourceLocation(Reference.MODID + ":textures/gui/container/gui_drill.png");
    private TileEntityDrill tile;

    public GuiDrill(InventoryPlayer player, TileEntityDrill tile) {
        super(new DrillContainer(player, tile));
        this.tile = tile;
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        int textureWidth = (int) (19f / 560f * timePassed);
        this.drawTexturedModalRect(i + 99, j + 35, 230, 12, textureWidth, 12);

        if (this.tile.isBurning()) {
            int burningTime = this.tile.getField(0);
            int textureHeight = (int) (12f / this.tile.getFullBurnTime() * burningTime);
            this.drawTexturedModalRect(i + 21, j + 18, 230, 0, 26, textureHeight);
        }
