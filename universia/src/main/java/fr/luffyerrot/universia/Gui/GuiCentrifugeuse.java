...
public class GuiCentrifugeuse extends GuiContainer {

    private static final ResourceLocation background = new ResourceLocation(Reference.MODID + ":textures/gui/container/gui_centrifugeuse.png");
    private TileEntityCentrifugeuse tile;

    public GuiCentrifugeuse(InventoryPlayer player, TileEntityCentrifugeuse tile) {
        super(new CentrifugeuseContainer(player, tile));
        this.tile = tile;
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        int textureWidth = (int) (18f / this.tile.getFullRecipeTime() * timePassed);
        this.drawTexturedModalRect(i + 86, j + 31, 230, 62, textureWidth, 24);
