...
public class GuiSechoir extends GuiContainer {

    private static final ResourceLocation background = new ResourceLocation(Reference.MODID + ":textures/gui/container/gui_sechoir.png");
    private TileEntitySechoir tile;

    public GuiSechoir(InventoryPlayer player, TileEntitySechoir tile) {
        super(new SechoirContainer(player, tile));
        this.tile = tile;
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        int textureWidth = (int) (10f / this.tile.getFullRecipeTime() * timePassed);
        this.drawTexturedModalRect(i + 119, j + 36, 230, 62, textureWidth, 10);
